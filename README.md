...
<a href="https://www.kaggle.com/rahulchandrashil"><img src="https://img.shields.io/badge/Kaggle-20BEFF?style=flat&logo=kaggle&logoColor=white"/></a>
...
- Bengali Language Datasets and NLP Resources
- Machine Learning for Educational Technology
- Dataset Construction and Data Annotation
...
- Multi-criteria scoring algorithm using Bayesian weighted rating formula
- Supports 8+ languages including Bengali, Korean, Japanese and more
- Deployed live on [Render.com](http://Render.com) with Glassmorphism UI design

### 🧭 RolyX — AI-Powered Career Intelligence Platform
> An end-to-end AI platform that matches skills to real job postings, predicts salary ranges from job descriptions, classifies industries, and lets users compare roles side-by-side — built on an enriched LinkedIn Job Postings dataset of 123,842+ listings.

[![Live Demo](https://img.shields.io/badge/🌐%20Live%20Demo-rolyx-3B82F6?style=for-the-badge)](https://rolyx-careers.streamlit.app)
[![GitHub](https://img.shields.io/badge/GitHub-Repository-181717?style=for-the-badge&logo=github)](https://github.com/CyberSurgeon01/RolyX)
[![Hugging Face](https://img.shields.io/badge/🤗%20Hugging%20Face-Models-FFD21E?style=for-the-badge)](https://huggingface.co/rahulchandrashil/RolyX)
...
- TF-IDF Vectorization + Cosine Similarity for skill-based job matching and role lookup
- Ridge Regression for salary range prediction from job descriptions
- Logistic Regression for industry classification (top-20 industries, confidence-ranked)
- Resume parsing (PDF/DOCX) with automatic skill extraction and job matching
...
## Tools
<p>
<img src="https://skillicons.dev/icons?i=linux,vscode,visualstudio,anaconda,github,figma,flask" />
</p>
<p>
...
- Contributing to Machine Learning and Data Science repositories
...
<p align="center">
<img src="https://capsule-render.vercel.app/api?type=waving&color=0:61a5c2,50:2a6f97,100:1d3557&height=120&section=footer"/>
</p>
